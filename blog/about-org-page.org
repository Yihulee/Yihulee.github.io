...
无法转换到 *source* 分支，什么鬼？怎么会出这个错误？如果用户是小白，立马懵逼了。

对，刚开始的我也是这样的。我在自己的 *win7* 上试了几遍，每次都报错，我怀疑，作者设计的这个东西只能用在 *linux* 上面？我换了 *ubuntu kylin* 去尝试，依旧问题不断，我配着配着感到很恶心，停止了一段时间。
